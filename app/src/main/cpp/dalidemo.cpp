...
public:
  ...
  void Create( Application& application )
  {
    ...
    editButton.SetProperty( Toolkit::Button::Property::LABEL, "Model" );
    ...
    editButton.SetProperty( Toolkit::Button::Property::LABEL, "Shader" );
    mButtonLayer.Add( editButton  );
    ...
    editButton.SetProperty( Toolkit::Button::Property::LABEL, "Pause" );
    mButtonLayer.Add( editButton  );
